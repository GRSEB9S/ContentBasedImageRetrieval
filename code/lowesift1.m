...
Jpegfile=dir('C:\Users\Nagraj\Downloads\SIFT_and _SURF\SIFT_and _SURF\*.jpg');
number1=length(Jpegfile);
a='C:\Users\Nagraj\Downloads\SIFT_and _SURF\SIFT_and _SURF\';
keypoints_finals=cell(1,number1);
files=cell(1,number1);
for start=1:number1
im = strcat(a,Jpegfile(start).name);im
image=imread(im);
